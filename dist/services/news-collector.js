...
import { uniqueArray, generateId, calculateSimilarity } from '../utils/helpers.js';
...
export class NewsCollector {
     ...
     * 从单个新闻源收集新闻
     */
    async collectNewsFromSource(source) {
        try {
     ...
     * 通过NewsNow API获取新闻数据
     */
    async fetchNewsFromMCP(sourceId, count) {
     ...
     * 转换MCP响应为NewsItem格式
     */
    transformMCPResponse(response, source) {
        // 处理直接的API响应格式 {items: [...]}
...
//# sourceMappingURL=news-collector.js.map